...
public class ActionsAspect implements CopyServicePolicies.OnCopyNodePolicy, CopyServicePolicies.OnCopyCompletePolicy, NodeServicePolicies.OnDeleteAssociationPolicy
{
    ...
    public void init()
    {
        ...
        this.policyComponent.bindAssociationBehaviour(
                ...
                org.alfresco.repo.action.ActionModel.TYPE_ACTION_SCHEDULE,
                org.alfresco.repo.action.ActionModel.ASSOC_SCHEDULED_ACTION,
                new JavaBehaviour(this, "onDeleteAssociation"));
        
        this.policyComponent.bindClassBehaviour(
                CopyServicePolicies.OnCopyNodePolicy.QNAME,
                org.alfresco.repo.action.ActionModel.ASPECT_ACTIONS,
    ...
    private static class ActionsAspectCopyBehaviourCallback extends DefaultCopyBehaviourCallback
    {
        ...
        public boolean getMustCopy(QName classQName, CopyDetails copyDetails)
        {
            ...
            behaviourFilter.disableBehaviour(targetNodeRef, org.alfresco.repo.action.ActionModel.ASPECT_ACTIONS);
            // Always copy
            return true;
        }
                ...
                CopyChildAssociationDetails childAssocCopyDetails)
        {
            ...
            if (childAssocRef.getTypeQName().equals(org.alfresco.repo.action.ActionModel.ASSOC_ACTION_FOLDER))
            {
