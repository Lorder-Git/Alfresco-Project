...
public class CompositeActionImpl extends ActionImpl implements CompositeAction
{
    ...
    /**
     * @param action Action
     * @see ActionList#addAction(Action)
     */
     ...
     * @param action Action
     * @return int
     * @see ActionList#indexOfAction(Action)
     */
    ...
    /**
     * @param action Action
     * @see ActionList#removeAction(Action)
     */
    ...
    /**
     * @see ActionList#removeAllActions()
     */
