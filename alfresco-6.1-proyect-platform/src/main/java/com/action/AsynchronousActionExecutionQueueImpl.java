...
public class AsynchronousActionExecutionQueueImpl implements AsynchronousActionExecutionQueue
{
    ...
    /** Services */
    private org.alfresco.repo.action.ActionServiceImpl actionServiceImpl;
    private ThreadPoolExecutor threadPoolExecutor;
    private TransactionService transactionService;
    private PolicyComponent policyComponent;
    private Map<String, org.alfresco.repo.action.AbstractAsynchronousActionFilter>
            actionFilters = new ConcurrentHashMap<String, org.alfresco.repo.action.AbstractAsynchronousActionFilter>();
    private String id;
     ...
     */
    List<org.alfresco.repo.action.OngoingAsyncAction> ongoingActions = new Vector<org.alfresco.repo.action.OngoingAsyncAction>();
     ...
     */
    public void registerActionFilter(org.alfresco.repo.action.AbstractAsynchronousActionFilter filter)
    {
        ...
        org.alfresco.repo.action.AbstractAsynchronousActionFilter existingFilter = actionFilters.get(filterName);
     ...
     * {@inheritDoc}
     */
    public void executeAction(org.alfresco.repo.action.RuntimeActionService actionService, Action action, NodeRef actionedUponNodeRef,
                              ...
                              boolean checkConditions, Set<String> actionChain, NodeRef actionExecutionHistoryNodeRef)
    {
        ...
        org.alfresco.repo.action.OngoingAsyncAction nodeBeingNewlyActioned = new org.alfresco.repo.action.OngoingAsyncAction(actionedUponNodeRef, action);
        
        for (Entry<String, org.alfresco.repo.action.AbstractAsynchronousActionFilter> entry : actionFilters.entrySet())
        {
            ...
            else
            {
                ...
                {
                    for (org.alfresco.repo.action.OngoingAsyncAction ongoingAction : this.ongoingActions)
                    {
    ...
    private void handleAsyncActionIsCompleted(NodeRef n, Action action) {
        ...
        org.alfresco.repo.action.OngoingAsyncAction ongoing = new OngoingAsyncAction(n, action);
    ...
    private class ActionExecutionWrapper implements Runnable
    {
        ...
        public void run()
        {
            try
            {
                ...
                final String userName = ((org.alfresco.repo.action.ActionImpl)ActionExecutionWrapper.this.action).getRunAsUser();
                if (userName == null)
                {
