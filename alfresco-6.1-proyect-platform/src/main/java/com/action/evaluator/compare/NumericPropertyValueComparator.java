...
public class NumericPropertyValueComparator implements PropertyValueComparator
{
    ...
    /**
     * @see PropertyValueComparator#compare(Serializable, Serializable, org.alfresco.repo.action.evaluator.compare.ComparePropertyValueOperation)
     */
    public boolean compare(
            Serializable propertyValue,
            Serializable compareValue, 
            org.alfresco.repo.action.evaluator.compare.ComparePropertyValueOperation operation)
    {
    ...
    /**
     * @see PropertyValueComparator#registerComparator(ComparePropertyValueEvaluator)
     */
