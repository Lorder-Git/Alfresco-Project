            ...
            CopyServicePolicies.OnCopyNodePolicy, CopyServicePolicies.OnCopyCompletePolicy
{
    ...
    public void init()
    {
        ...
        this.policyComponent.bindClassBehaviour(QName.createQName(NamespaceService.ALFRESCO_URI, "getCopyCallback"),
                    org.alfresco.repo.action.ActionModel.TYPE_ACTION_PARAMETER, new JavaBehaviour(this, "getCopyCallback"));
        this.policyComponent.bindClassBehaviour(QName.createQName(NamespaceService.ALFRESCO_URI, "onCopyComplete"),
                    org.alfresco.repo.action.ActionModel.TYPE_ACTION_PARAMETER, new JavaBehaviour(this, "onCopyComplete"));
    }
    ...
    private NodeRef getSavedActionFolderRef(NodeRef nodeRef)
    {
        List<ChildAssociationRef> assocs = this.nodeService.getChildAssocs(nodeRef, RegexQNamePattern.MATCH_ALL,
                    org.alfresco.repo.action.ActionModel.ASSOC_ACTION_FOLDER);
        if (assocs.size() != 1)
        {
    ...
    /**
     * @see ActionService#getActionDefinition(String)
     */
    ...
    /**
     * @see ActionService#getActionDefinitions()
     */
    ...
    /**
     * @see ActionService#getActionDefinitions(NodeRef)
     */
    ...
    /**
     * @see ActionService#getActionConditionDefinition(String)
     */
    ...
    /**
     * @see ActionService#getActionConditionDefinitions()
     */
    ...
    /**
     * @see ActionService#getParameterConstraint(String)
     */
    ...
    /**
     * @see ActionService#getParameterConstraints()
     */
    ...
    /**
     * @see ActionService#createActionCondition(String)
     */
    ...
    /**
     * @see ActionService#createAction(String)
     */
    public Action createAction(String name)
    {
        return new org.alfresco.repo.action.ActionImpl(null, GUID.generate(), name, null);
    }
    ...
    /**
     * @see ActionService#createCompositeAction()
     */
    ...
    /**
     * @see ActionService#createCompositeActionCondition()
     */
    ...
    /**
     * @see ActionService#evaluateAction(Action,
     *      NodeRef)
     */
     ...
     * 
     * @see ActionService#evaluateActionCondition(ActionCondition,
     *      NodeRef)
     */
    ...
    /**
     * @see ActionService#executeAction(Action,
     *      NodeRef, boolean)
     */
            ...
            catch (Throwable exception)
            {
                ...
                if (executedAsynchronously == true)
                {
                    ...
                    if (compensatingAction != null)
                    {
                        ...
                        ((org.alfresco.repo.action.ActionImpl) compensatingAction).setRunAsUser(currentUserName);
                        ((org.alfresco.repo.action.ActionImpl) compensatingAction).setTenantId(((org.alfresco.repo.action.ActionImpl)action).getTenantId());
    ...
    /**
     * @see RuntimeActionService#directActionExecution(Action,
     *      NodeRef)
     */
    ...
    /**
     * @see RuntimeActionService#registerActionConditionEvaluator(ActionConditionEvaluator)
     */
    ...
    /**
     * @see RuntimeActionService#registerActionExecuter(ActionExecuter)
     */
    ...
    /**
     * @see RuntimeActionService#registerParameterConstraint(ParameterConstraint)
     */
    ...
    private NodeRef getActionNodeRefFromId(NodeRef nodeRef, String actionId)
    {
        ...
        if (this.nodeService.hasAspect(nodeRef, org.alfresco.repo.action.ActionModel.ASPECT_ACTIONS) == true)
        {
    ...
    /**
     * @see ActionService#saveAction(NodeRef,
     *      Action)
     */
    public void saveAction(NodeRef nodeRef, Action action)
    {
        ...
        {
            if (this.nodeService.hasAspect(nodeRef, org.alfresco.repo.action.ActionModel.ASPECT_ACTIONS) == false)
            {
                // Apply the actionable aspect
                this.nodeService.addAspect(nodeRef, org.alfresco.repo.action.ActionModel.ASPECT_ACTIONS, null);
            }
            ...
            actionNodeRef = createActionNodeRef(action, getSavedActionFolderRef(nodeRef), ContentModel.ASSOC_CONTAINS,
                        org.alfresco.repo.action.ActionModel.ASSOC_NAME_ACTIONS);
        }
    ...
    public NodeRef createActionNodeRef(Action action, NodeRef parentNodeRef, QName assocTypeName, QName assocName)
    {
        ...
        props.put(org.alfresco.repo.action.ActionModel.PROP_DEFINITION_NAME, action.getActionDefinitionName());
        props.put(ContentModel.PROP_NODE_UUID, action.getId());

        QName actionType = org.alfresco.repo.action.ActionModel.TYPE_ACTION;
        if (action instanceof ActionList<?>)
        {
            actionType = org.alfresco.repo.action.ActionModel.TYPE_COMPOSITE_ACTION;
        }
        ...
        ((org.alfresco.repo.action.ActionImpl) action).setCreator((String) this.nodeService
                    .getProperty(actionNodeRef, ContentModel.PROP_CREATOR));
        ((org.alfresco.repo.action.ActionImpl) action).setCreatedDate((Date) this.nodeService.getProperty(actionNodeRef,
                    ContentModel.PROP_CREATED));
        ((org.alfresco.repo.action.ActionImpl) action).setNodeRef(actionNodeRef);

        return actionNodeRef;
    }

    /**
     * @see RuntimeActionService#saveActionImpl(NodeRef,
     *      Action)
     */
    public void saveActionImpl(NodeRef actionNodeRef, Action action)
    {
        ...
        ((org.alfresco.repo.action.ActionImpl) action).setModifier((String) this.nodeService.getProperty(actionNodeRef,
                    ContentModel.PROP_MODIFIER));
        ((org.alfresco.repo.action.ActionImpl) action).setModifiedDate((Date) this.nodeService.getProperty(actionNodeRef,
    ...
    private void saveActionProperties(NodeRef actionNodeRef, Action action)
    {
        ...
        props.put(org.alfresco.repo.action.ActionModel.PROP_ACTION_TITLE, action.getTitle());
        props.put(org.alfresco.repo.action.ActionModel.PROP_ACTION_DESCRIPTION, action.getDescription());
        if (action.getTrackStatus() != null)
        {
            props.put(org.alfresco.repo.action.ActionModel.PROP_TRACK_STATUS, action.getTrackStatus());
        }
        props.put(org.alfresco.repo.action.ActionModel.PROP_EXECUTE_ASYNCHRONOUSLY, action.getExecuteAsychronously());
        
        props.put(org.alfresco.repo.action.ActionModel.PROP_EXECUTION_START_DATE, action.getExecutionStartDate());
        props.put(org.alfresco.repo.action.ActionModel.PROP_EXECUTION_END_DATE, action.getExecutionEndDate());
        props.put(org.alfresco.repo.action.ActionModel.PROP_EXECUTION_ACTION_STATUS, action.getExecutionStatus());
        props.put(org.alfresco.repo.action.ActionModel.PROP_EXECUTION_FAILURE_MESSAGE, action.getExecutionFailureMessage());
        ...
        List<ChildAssociationRef> assocs = this.nodeService.getChildAssocs(actionNodeRef, RegexQNamePattern.MATCH_ALL,
                    org.alfresco.repo.action.ActionModel.ASSOC_COMPENSATING_ACTION);
        if (assocs.size() == 0)
        {
            if (compensatingAction != null)
            {
                ...
                NodeRef compensatingActionNodeRef = createActionNodeRef(compensatingAction, actionNodeRef,
                            org.alfresco.repo.action.ActionModel.ASSOC_COMPENSATING_ACTION, org.alfresco.repo.action.ActionModel.ASSOC_COMPENSATING_ACTION);
    ...
    private void saveCompositeActions(NodeRef compositeActionNodeRef, ActionList<?> action2)
    {
        ...
        List<ChildAssociationRef> actionRefs = this.nodeService.getChildAssocs(compositeActionNodeRef,
                    RegexQNamePattern.MATCH_ALL, org.alfresco.repo.action.ActionModel.ASSOC_ACTIONS);
        ...
        for (String actionId : orderedIds)
        {
            ...
            NodeRef actionNodeRef = this.nodeService.createNode(compositeActionNodeRef, org.alfresco.repo.action.ActionModel.ASSOC_ACTIONS,
                        org.alfresco.repo.action.ActionModel.ASSOC_ACTIONS, org.alfresco.repo.action.ActionModel.TYPE_ACTION, props).getChildRef();

            // Update the created details and the node reference
            ((org.alfresco.repo.action.ActionImpl) action).setCreator((String) this.nodeService.getProperty(actionNodeRef,
                ...
                boolean isComposite)
    {
        ...
        List<ChildAssociationRef> conditionRefs = this.nodeService.getChildAssocs(actionNodeRef,
                    RegexQNamePattern.MATCH_ALL, !isComposite ? org.alfresco.repo.action.ActionModel.ASSOC_CONDITIONS
                                : org.alfresco.repo.action.ActionModel.ASSOC_COMPOSITE_ACTION_CONDITION);
        ...
        for (String nextId : orderedIds)
        {
            ...
            if (!isComposite && actionCondition instanceof CompositeActionCondition)
            {
                ...
                NodeRef conditionNodeRef = saveActionCondition(actionNodeRef, actionCondition,
                            org.alfresco.repo.action.ActionModel.ASSOC_CONDITIONS, org.alfresco.repo.action.ActionModel.TYPE_COMPOSITE_ACTION_CONDITION);
            ...
            else
            {
                ...
                NodeRef conditionNodeRef = saveActionCondition(actionNodeRef, actionCondition,
                            !isComposite ? org.alfresco.repo.action.ActionModel.ASSOC_CONDITIONS : org.alfresco.repo.action.ActionModel.ASSOC_COMPOSITE_ACTION_CONDITION,
                            org.alfresco.repo.action.ActionModel.TYPE_ACTION_CONDITION);
            }
        }
    }
    ...
    {
        Map<QName, Serializable> props = new HashMap<QName, Serializable>(2);
        props.put(org.alfresco.repo.action.ActionModel.PROP_DEFINITION_NAME, actionCondition.getActionConditionDefinitionName());
    ...
    {
        this.nodeService.setProperty(conditionNodeRef, org.alfresco.repo.action.ActionModel.PROP_CONDITION_INVERT, condition
                    .getInvertCondition());
        ...
        if (condition instanceof CompositeActionCondition)
        {
            ...
            this.nodeService.setProperty(conditionNodeRef, org.alfresco.repo.action.ActionModel.PROP_CONDITION_ANDOR, new Boolean(
    ...
    private void saveParameters(NodeRef parameterizedNodeRef, ParameterizedItem item)
    {
        ...
        List<ChildAssociationRef> parameters = this.nodeService.getChildAssocs(parameterizedNodeRef,
                    org.alfresco.repo.action.ActionModel.ASSOC_PARAMETERS, org.alfresco.repo.action.ActionModel.ASSOC_PARAMETERS);
        for (ChildAssociationRef ref : parameters)
        {
            ...
            String paramName = (String) nodeRefParameterMap.get(org.alfresco.repo.action.ActionModel.PROP_PARAMETER_NAME);
            ...
            else
            {
                ...
                nodeRefParameterMap.put(org.alfresco.repo.action.ActionModel.PROP_PARAMETER_VALUE, parameterMap.get(paramName));
        ...
        for (Map.Entry<String, Serializable> entry : parameterMap.entrySet())
        {
            ...
            nodeRefProperties.put(org.alfresco.repo.action.ActionModel.PROP_PARAMETER_NAME, entry.getKey());
            nodeRefProperties.put(org.alfresco.repo.action.ActionModel.PROP_PARAMETER_VALUE, entry.getValue());

            this.nodeService.createNode(parameterizedNodeRef, org.alfresco.repo.action.ActionModel.ASSOC_PARAMETERS,
                        org.alfresco.repo.action.ActionModel.ASSOC_PARAMETERS, org.alfresco.repo.action.ActionModel.TYPE_ACTION_PARAMETER, nodeRefProperties);
        }
    }
    ...
    /**
     * @see ActionService#getActions(NodeRef)
     */
    public List<Action> getActions(NodeRef nodeRef)
    {
        ...
        if (this.nodeService.exists(nodeRef) == true
                    && this.nodeService.hasAspect(nodeRef, org.alfresco.repo.action.ActionModel.ASPECT_ACTIONS) == true)
        {
            List<ChildAssociationRef> actions = this.nodeService.getChildAssocs(getSavedActionFolderRef(nodeRef),
                        RegexQNamePattern.MATCH_ALL, org.alfresco.repo.action.ActionModel.ASSOC_NAME_ACTIONS);
    ...
    public Action createAction(NodeRef actionNodeRef)
    {
        ...
        if (org.alfresco.repo.action.ActionModel.TYPE_COMPOSITE_ACTION.equals(actionType) == true)
        {
        ...
        {
            // Create an action
            result = new org.alfresco.repo.action.ActionImpl(actionNodeRef, actionNodeRef.getId(), (String) properties
                        .get(org.alfresco.repo.action.ActionModel.PROP_DEFINITION_NAME));
    ...
    private void populateAction(NodeRef actionNodeRef, Action action)
    {
        ...
        List<ChildAssociationRef> conditions = this.nodeService.getChildAssocs(actionNodeRef,
                    RegexQNamePattern.MATCH_ALL, org.alfresco.repo.action.ActionModel.ASSOC_CONDITIONS);
    ...
    private void populateActionProperties(NodeRef actionNodeRef, Action action)
    {
        ...
        action.setTitle((String) props.get(org.alfresco.repo.action.ActionModel.PROP_ACTION_TITLE));
        action.setDescription((String) props.get(org.alfresco.repo.action.ActionModel.PROP_ACTION_DESCRIPTION));

        Boolean trackStatusObj = (Boolean) props.get(org.alfresco.repo.action.ActionModel.PROP_TRACK_STATUS);
        action.setTrackStatus(trackStatusObj);              // Allowed to be null

        Boolean executeAsynchObj = (Boolean) props.get(org.alfresco.repo.action.ActionModel.PROP_EXECUTE_ASYNCHRONOUSLY);
        ...
        ((org.alfresco.repo.action.ActionImpl) action).setCreator((String) props.get(ContentModel.PROP_CREATOR));
        ((org.alfresco.repo.action.ActionImpl) action).setCreatedDate((Date) props.get(ContentModel.PROP_CREATED));
        ((org.alfresco.repo.action.ActionImpl) action).setModifier((String) props.get(ContentModel.PROP_MODIFIER));
        ((org.alfresco.repo.action.ActionImpl) action).setModifiedDate((Date) props.get(ContentModel.PROP_MODIFIED));
        
        ((org.alfresco.repo.action.ActionImpl) action).setExecutionStartDate((Date) props.get(org.alfresco.repo.action.ActionModel.PROP_EXECUTION_START_DATE));
        ((org.alfresco.repo.action.ActionImpl) action).setExecutionEndDate((Date) props.get(org.alfresco.repo.action.ActionModel.PROP_EXECUTION_END_DATE));
        ((org.alfresco.repo.action.ActionImpl) action).setExecutionStatus(ActionStatus.valueOf(props.get(org.alfresco.repo.action.ActionModel.PROP_EXECUTION_ACTION_STATUS)));
        ((org.alfresco.repo.action.ActionImpl) action).setExecutionFailureMessage((String) props.get(org.alfresco.repo.action.ActionModel.PROP_EXECUTION_FAILURE_MESSAGE));
    ...
    private void populateParameters(NodeRef parameterizedItemNodeRef, ParameterizedItem parameterizedItem)
    {
        List<ChildAssociationRef> parameters = this.nodeService.getChildAssocs(parameterizedItemNodeRef,
                    RegexQNamePattern.MATCH_ALL, org.alfresco.repo.action.ActionModel.ASSOC_PARAMETERS);
        for (ChildAssociationRef parameter : parameters)
        {
            ...
            parameterizedItem.setParameterValue((String) properties.get(org.alfresco.repo.action.ActionModel.PROP_PARAMETER_NAME), properties
                        .get(org.alfresco.repo.action.ActionModel.PROP_PARAMETER_VALUE));
        }
    }
    ...
    private ActionCondition createActionCondition(NodeRef conditionNodeRef)
    {
        ...
        if (org.alfresco.repo.action.ActionModel.TYPE_COMPOSITE_ACTION_CONDITION.equals(conditionType) == false)
        {
        ...
        Boolean invert = (Boolean) this.nodeService.getProperty(conditionNodeRef, org.alfresco.repo.action.ActionModel.PROP_CONDITION_INVERT);
                ...
                CompositeActionCondition compositeActionCondition)
    {
        List<ChildAssociationRef> conditions = this.nodeService.getChildAssocs(compositeNodeRef,
                    RegexQNamePattern.MATCH_ALL, org.alfresco.repo.action.ActionModel.ASSOC_COMPOSITE_ACTION_CONDITION);

        Boolean OR = (Boolean) this.nodeService.getProperty(compositeNodeRef, org.alfresco.repo.action.ActionModel.PROP_CONDITION_ANDOR);
    ...
    /**
     * @see ActionService#getAction(NodeRef,
     *      String)
     */
    ...
    /**
     * @see ActionService#removeAction(NodeRef,
     *      Action)
     */
    ...
    /**
     * @see ActionService#removeAllActions(NodeRef)
     */
    public void removeAllActions(NodeRef nodeRef)
    {
                    ...
                    && this.nodeService.hasAspect(nodeRef, org.alfresco.repo.action.ActionModel.ASPECT_ACTIONS) == true)
        {
            List<ChildAssociationRef> actions = new ArrayList<ChildAssociationRef>(this.nodeService.getChildAssocs(
                        getSavedActionFolderRef(nodeRef), RegexQNamePattern.MATCH_ALL, org.alfresco.repo.action.ActionModel.ASSOC_NAME_ACTIONS));
            for (ChildAssociationRef action : actions)
            {
                ...
                Set<String> actionChain)
    {
        ...
        if (actionChain == null || actionChain.contains(action.getId()) == false)
        {
            ...
            ((org.alfresco.repo.action.ActionImpl) action).setRunAsUser(AuthenticationUtil.getRunAsUser());
    ...
    private static class ActionParameterTypeCopyBehaviourCallback extends DefaultCopyBehaviourCallback
    {
                    ...
                    Map<QName, Serializable> properties)
        {
            ...
            recordNodeRefsForRepointing(sourceNodeRef, properties, org.alfresco.repo.action.ActionModel.PROP_PARAMETER_VALUE);
