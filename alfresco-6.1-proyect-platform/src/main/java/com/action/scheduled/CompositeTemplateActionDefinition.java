...
public class CompositeTemplateActionDefinition extends AbstractTemplateActionDefinition
{
     ...
     */
    private List<org.alfresco.repo.action.scheduled.TemplateActionDefinition> templateActionDefinitions;
     ...
     * 
     */
    public void setTemplateActionDefinitions(List<org.alfresco.repo.action.scheduled.TemplateActionDefinition> templateActionDefinitions)
    {
     ...
     */
    public List<org.alfresco.repo.action.scheduled.TemplateActionDefinition> templateActionDefinitions()
    {
