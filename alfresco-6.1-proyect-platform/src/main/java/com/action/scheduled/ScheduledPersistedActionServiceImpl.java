...
public class ScheduledPersistedActionServiceImpl implements ScheduledPersistedActionService
{
    ...
    public void schedulePreviouslyPersisted()
    {
        ...
        for (ScheduledPersistedAction action : actions)
        {
            ...
            {
               addToScheduler((org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl) action);
            }
        }
    }
    ...
    {
        return new org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl(persistedAction);
    }
    ...
    {
        org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl scheduleImpl = (org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl)schedule;
    ...
    private void createPersistentSchedule(org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl schedule)
    {
    ...
    private void updatePersistentSchedule(org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl schedule)
    {
    ...
    private void deletePersistentSchedule(org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl schedule)
    {
        NodeRef nodeRef = schedule.getPersistedAtNodeRef();
        if (nodeRef == null)
            return;
    ...
    private List<ScheduledPersistedAction> listSchedules(NodeService nodeService)
    {
        ...
        {
            org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl scheduleImpl = loadPersistentSchedule(actionAssoc.getChildRef());
    ...
    protected org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl loadPersistentSchedule(NodeRef schedule)
    {
        ...
        // create schedule
        org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl scheduleImpl = new org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl(action);
     ...
     */
    protected void removeFromScheduler(org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl schedule)
    {
     ...
     */
    protected void addToScheduler(org.alfresco.repo.action.scheduled.ScheduledPersistedActionImpl schedule)
    {
