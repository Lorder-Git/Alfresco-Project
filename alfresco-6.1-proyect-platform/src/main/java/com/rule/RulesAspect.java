                 ...
                 NodeServicePolicies.BeforeDeleteNodePolicy
{
    ...
    public void onAddAspect(NodeRef nodeRef, QName aspectTypeQName)
    {
        ...
        try
        {
            int count = this.nodeService.getChildAssocs(nodeRef, org.alfresco.repo.rule.RuleModel.ASSOC_RULE_FOLDER, org.alfresco.repo.rule.RuleModel.ASSOC_RULE_FOLDER).size();
            if (count == 0)
            {
    ...
    {
        if (!aspectTypeQName.equals(org.alfresco.repo.rule.RuleModel.ASPECT_RULES))
        {
            return;
        }
        ...
        try
        {
            for (ChildAssociationRef childAssocRef : nodeService.getChildAssocs(nodeRef, org.alfresco.repo.rule.RuleModel.ASSOC_RULE_FOLDER,
                    org.alfresco.repo.rule.RuleModel.ASSOC_RULE_FOLDER, false))
            {
                ...
                for (ChildAssociationRef linkAssoc : linkedAssocs)
                {
                    if (!linkAssoc.isPrimary())
                    {
                        ...
                        // association
                        nodeService.removeAspect(linkAssoc.getParentRef(), org.alfresco.repo.rule.RuleModel.ASPECT_RULES);
                    }
                }
            }
        }
    ...
    public void beforeDeleteNode(NodeRef nodeRef)
    {
        ...
        beforeRemoveAspect(nodeRef, org.alfresco.repo.rule.RuleModel.ASPECT_RULES);
    }
    ...
    private static class RulesAspectCopyBehaviourCallback extends DefaultCopyBehaviourCallback
    {
        ...
        public boolean getMustCopy(QName classQName, CopyDetails copyDetails)
        {
            ...
            behaviourFilter.disableBehaviour(targetNodeRef, org.alfresco.repo.rule.RuleModel.ASPECT_RULES);
            // Always copy
            return true;
        }
         ...
         *                  for {@link org.alfresco.repo.rule.RuleModel#ASSOC_RULE_FOLDER}
         */
        @Override
                ...
                CopyChildAssociationDetails childAssocCopyDetails)
        {
            ...
            if (childAssocRef.getTypeQName().equals(org.alfresco.repo.rule.RuleModel.ASSOC_RULE_FOLDER))
            {
